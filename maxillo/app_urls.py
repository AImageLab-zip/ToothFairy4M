...
urlpatterns = [
    ...
    path("load/", views.upload_patient, name="load_patient"),
    ...
    path(
        "api/processing/jobs/pending/<str:job_type>/",
        api_views.get_pending_jobs,
        name="api_get_pending_jobs",
    ),
    path(
    ...
    path(
        "api/processing/jobs/<int:job_id>/processing/",
        api_views.mark_job_processing,
        name="api_mark_job_processing",
    ),
    path(
        "api/processing/jobs/<int:job_id>/completed/",
        api_views.mark_job_completed_api,
        name="api_mark_job_completed",
    ),
    path(
        "api/processing/jobs/<int:job_id>/failed/",
        api_views.mark_job_failed_api,
        name="api_mark_job_failed",
    ),
    path(
