...
class ReadOnlyAdminMixin:
    ...
    def has_add_permission(self, request):
        if (
            ...
            and request.user.profile.is_student_developer()
        ):
            return False
...
class PatientAdmin(ReadOnlyAdminMixin, admin.ModelAdmin):
    ...
    def get_queryset(self, request):
        ...
        qs = qs.exclude(project__slug="laparoscopy")
        if (
            hasattr(request.user, "profile")
            and request.user.profile.is_student_developer()
        ):
...
class JobAdmin(ReadOnlyAdminMixin, admin.ModelAdmin):
    ...
    list_filter = [
        ...
        "completed_at",
        "priority",
        ("dependencies", admin.EmptyFieldListFilter),
    ]
    ...
    fieldsets = (
        ...
        ("Files & Processing", {"fields": ("input_file_path", "output_files")}),
        ("Timing", {"fields": ("created_at", "started_at", "completed_at")}),
        ("Error Handling", {"fields": ("retry_count", "max_retries", "error_logs")}),
        ("Worker Info", {"fields": ("worker_id",)}),
    )
...
class FileRegistryAdmin(ReadOnlyAdminMixin, admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Related Objects", {"fields": ("patient", "voice_caption", "processing_job")}),
...
class ExportAdmin(ReadOnlyAdminMixin, admin.ModelAdmin):
    ...
    fieldsets = (
        ("Status", {"fields": ("user", "status", "error_message")}),
        ("Query", {"fields": ("query_params", "query_summary")}),
        ("Result", {"fields": ("file_path", "file_size", "patient_count")}),
        ("Timing", {"fields": ("created_at", "started_at", "completed_at")}),
    )
