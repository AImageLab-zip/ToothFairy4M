...
from .views.patient_detail import patient_segmentation
from .views.patient_data import patient_intraoral_segmentation_data, update_intraoral_segmentation
...
urlpatterns = [
    ...
    path('patient/<int:patient_id>/segmentation/', patient_segmentation, name='patient_segmentation'),
    ...
    path('api/patient/<int:patient_id>/intraoral-segmentation/', patient_intraoral_segmentation_data, name='patient_intraoral_segmentation_data'),
    path('api/patient/<int:patient_id>/intraoral-segmentation/update/', update_intraoral_segmentation, name='update_intraoral_segmentation'),
