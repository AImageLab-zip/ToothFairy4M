...
export function applyApiMixin(proto) {
        ...
        proto._requestJson = function (url, options) {
            return fetch(url, options)
                .then(_jsonOrNull)
                .catch(function () { return null; });
        };

        proto._requestVoid = function (url, options) {
            return fetch(url, options)
                .then(function () { return null; })
                .catch(function () { return null; });
        };

        proto._persistRegionType = function (region) {
        ...
        proto._loadRegionTypes = function () {
            var self = this;
            return this._requestJson('/laparoscopy/api/region-types/')
                .then(function (data) {
        ...
        proto._deleteAnnotationById = function (annotationId) {
        ...
        proto._createAnnotationForShape = function (shape) {
        ...
        proto._patchAnnotationForShape = function (shape, patchData) {
        ...
        proto._persistShapeGeometry = function (shape) {
        ...
        proto._hydrateRegionAnnotation = function (annotation) {
        ...
        proto._loadRegionAnnotations = function () {
            var listUrl = this._annotationCollectionUrl();
            if (!listUrl) return;
        ...
        proto._persistTimelineClass = function (cls) {
        ...
        proto._loadQuadrantTypes = function () {
            var self = this;
            return this._requestJson('/laparoscopy/api/quadrant-types/')
                .then(function (data) {
                    if (!data || !data.types) return;
        ...
        proto._timelineMarkersCollectionUrl = function () {
            if (!this.patientId) return null;
            return '/laparoscopy/api/patient/' + this.patientId + '/quadrant-markers/';
        };

        proto._timelinePinsToPayload = function () {
            var self = this;
        ...
        proto._applyTimelineMarkers = function (data) {
        ...
        proto._loadTimelineMarkers = function () {
        ...
        proto._scheduleTimelineMarkersSync = function () {
            var url = this._timelineMarkersCollectionUrl();
            if (!url) return;
        ...
        proto._flushTimelineMarkersSync = function () {
            var url = this._timelineMarkersCollectionUrl();
            if (!url) return;
